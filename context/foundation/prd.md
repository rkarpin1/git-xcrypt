...
- Codzienne operacje gita (dodanie do indeksu, commit, checkout, przełączenie gałęzi) na typowym pliku konfiguracyjnym nie są odczuwalnie wolniejsze niż w repozytorium bez szyfrowania. **Próg liczbowy rozstrzygnięty 2026-08-06** (Open Question 5) — trzy budżety, bo mierzą trzy różne rzeczy:
