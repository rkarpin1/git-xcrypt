...
Read the PRD's `## Open Questions` first; none of them blocks today. Pick work from the roadmap's `## Backlog Handoff` — `S-07`, the cross-platform binaries, is what is left of v0.1.
